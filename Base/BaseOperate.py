...
class OperateElement:
    ...
    # 获取到元素到坐标点击，主要解决浮动层遮档无法触发driver.click的问题
    def touch_tap(self, mOperate):
        #[(711, 761), (909, 959)]

        list_m = "".join([mOperate['element_info']])
        list_x = '[' + list_m + ']'
        print(list_x)
        self.driver.tap([(206,574),(514,652)], 500)
        print("已执行")
        #print(cmd)
        #os.system(cmd)
        return {"result": True}
    ...
    def elements_by(self, mOperate):
        ...
        elements = {
            ...
            #be.TOUCH_TAP: lambda: self.driver.tap(list(mOperate['element_info']),100)
